...
import womenblazerData from '../data/womenblazerData.js';



function Womenblazer() {

  const cleanData = Array.isArray(womenblazerData)

    ? womenblazerData

    : (womenblazerData && Array.isArray(womenblazerData.womenblazerData) ? womenblazerData.womenblazerData : []);
  ...
  if (cleanData.length === 0) {
    ...
    return (
      ...
      <div className="pt-32 text-center min-h-screen bg-white text-zinc-800">
        ...
        <p className="tracking-widest uppercase text-sm">No items matching specifications found.</p>
    ...
    <div style={{ maxWidth: '1400px' }} className="mx-auto px-12 lg:px-20 -mt-20">        
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-10 gap-y-5 -mb-20">
          ...
          <div style={{ aspectRatio: '3 / 4' }}
           ...
           className="w-full bg-white overflow-hidden flex items-center justify-center relative">                
