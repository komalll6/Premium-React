...
const MenswearPage = () => <div className="pt-32 px-4 text-center min-h-screen bg-[#f3ede4] font-light tracking-widest text-zinc-800 text-sm sm:text-base">MENSWEAR COLLECTION COMING SOON</div>;
const WomenswearPage = () => <div className="pt-32 px-4 text-center min-h-screen bg-[#f3ede4] font-light tracking-widest text-zinc-800 text-sm sm:text-base">WOMENSWEAR COLLECTION COMING SOON</div>;
...
const FormalLookbookPage = () => {
  ...
  return (
    <div className="pt-10 pb-16 bg-[#f3ede4] min-h-screen">
      <div className="text-center max-w-3xl mx-auto px-4 mb-10 flex flex-col items-center">
        <h1 className="text-xl sm:text-2xl md:text-4xl tracking-[0.15em] md:tracking-[0.2em] text-zinc-900 uppercase font-light leading-snug">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 lg:gap-12">
          {formalImages.map((src, index) => (
            <div key={index} className="overflow-hidden bg-zinc-200 shadow-sm rounded-sm group w-full">
              <img 
                src={src} 
                alt={`Formal Look ${index + 1}`} 
                className="w-full aspect-[3/4] md:aspect-auto md:h-[600px] lg:h-[650px] object-cover object-top transition-transform duration-700 ease-out group-hover:scale-105 will-change-transform"/>            
          </div>
          ))}
        </div>
      </div>
...
const CasualLookbookPage = () => {
  ...
  return (
    <div className="pt-10 pb-16 bg-[#f3ede4] min-h-screen">
      <div className="text-center max-w-3xl mx-auto px-4 mb-10 flex flex-col items-center">
        <h1 className="text-xl sm:text-2xl md:text-4xl font-extrabold tracking-[0.15em] md:tracking-[0.2em] text-zinc-900 uppercase leading-snug">
          ...
          {casualImages.map((src, index) => (
            <div key={index} className="overflow-hidden bg-zinc-200 shadow-sm rounded-sm group w-full">
              <img 
                ...
                className="w-full h-[420px] sm:h-[520px] md:h-[600px] lg:h-[650px] object-cover object-top transition-transform duration-700 ease-out group-hover:scale-105" 
              />            
            </div>
          ))}
        </div>
    ...
    <div className="bg-[#f3ede4] min-h-screen flex flex-col justify-between">
      ...
      <main className="grow">        
        <Routes>
          ...
          {/* Handled paths to route to Showroom component */}
          <Route path="/showrooms" element={<Showroom />} />
          <Route path="/where" element={<Showroom />} />
